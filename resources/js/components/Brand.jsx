...
const Brand = () => {
    ...
    const handleDelete = async (e) => {
        await axios.delete(`http://localhost:80/proyectoPrueba1/public/api/delete_brand/${e}`,
            {
                headers: {
                    'Content-Type': 'multipart/form-data',
                    'Accept': 'application/json',
    ...
    const makeBrand = async () => {
        ...
        await axios.post('http://localhost:80/proyectoPrueba1/public/api/new_brand',
            formData,
            {
                headers: {
                    'Content-Type': 'multipart/form-data',
    ...
    return (
        <Container className="main">
            ...
            <Card.Title className="text-center w-100"><h1>Brands</h1></Card.Title>
